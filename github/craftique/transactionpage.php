...
<body>
    ...
    function calculateTotal() {
        ...
        paymentSection.style.display = (total + authTotal) > 0 ? 'block' : 'none';
    }
    
    // Enable/disable document inputs based on auth checkbox
    ...
    authCheckbox.addEventListener('change', toggleDocumentInputs);
    ...
    // Page count changes - using 'input' event for immediate feedback
    pageCounts.forEach(input => {
